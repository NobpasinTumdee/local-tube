...
export default function FilterBar() {
    ...
    return (_jsxs("div", { className: "flex items-center gap-3 overflow-x-auto pb-1 scrollbar-thin", children: [_jsx("div", { className: "flex shrink-0 items-center gap-1 rounded-xl border border-content/[0.06] bg-content/[0.03] p-1", children: typeFilters.map((f) => {
