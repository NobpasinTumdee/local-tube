...
export default function MediaViewer() {
    ...
    return (_jsxs(motion.section, { layout: true, initial: { opacity: 0, y: -8 }, animate: { opacity: 1, y: 0 }, transition: { type: 'spring', damping: 26, stiffness: 300 }, className: "overflow-hidden rounded-2xl border border-content/10 bg-surface/50 shadow-xl shadow-black/20 backdrop-blur-sm", children: [_jsxs("div", { className: "flex items-center gap-2 border-b border-content/10 px-3 py-2", children: [_jsx(LayoutGrid, { className: "h-4 w-4 text-primary" }), _jsx("span", { className: "text-sm font-semibold text-content", children: "Layout" }), _jsxs("span", { className: "rounded-full bg-content/10 px-2 py-0.5 text-[11px] tabular-nums text-content/60", children: [filled, " item", filled === 1 ? '' : 's'] }), _jsxs("div", { className: "ml-auto flex items-center gap-1", children: [_jsx(MasterBtn, { label: "Play all videos", onClick: playAll, disabled: videoCount === 0, children: _jsx(Play, { className: "h-4 w-4" }) }), _jsx(MasterBtn, { label: "Pause all videos", onClick: pauseAll, disabled: videoCount === 0, children: _jsx(Pause, { className: "h-4 w-4" }) }), _jsx(MasterBtn, { label: "Unmute all videos", onClick: () => muteAll(false), disabled: videoCount === 0, children: _jsx(Volume2, { className: "h-4 w-4" }) }), _jsx(MasterBtn, { label: "Mute all videos", onClick: () => muteAll(true), disabled: videoCount === 0, children: _jsx(VolumeX, { className: "h-4 w-4" }) }), _jsx("span", { className: "mx-1 h-5 w-px bg-content/10" }), _jsx(MasterBtn, { label: "Clear layout", onClick: clearLayout, disabled: filled === 0, children: _jsx(Trash2, { className: "h-4 w-4" }) }), _jsx(MasterBtn, { label: "Exit layout mode", onClick: () => setLayoutMode(false), children: _jsx(X, { className: "h-4 w-4" }) })] })] }), _jsxs("div", { className: "p-2 sm:p-3", children: [_jsx(motion.div, { layout: true, className: `grid h-[46vh] gap-2 sm:h-[58vh] ${cfg.container}`, children: _jsx(AnimatePresence, { initial: false, children: activeMedia.map((id, i) => (_jsx(motion.div, { layout: true, initial: { opacity: 0, scale: 0.92 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.92 }, transition: { type: 'spring', damping: 28, stiffness: 340, mass: 0.7 }, className: `relative min-h-0 min-w-0 ${cfg.spanFor(i)}`, children: _jsx(MediaTile, { slot: i, mediaId: id, onRegister: register }) }, `slot-${i}`))) }) }), filled === 0 && (_jsx("p", { className: "mt-3 text-center text-xs text-content/40", children: "Click any video or image in the library below to drop it into a slot \u2014 or drag it onto a specific cell." }))] })] }));
}
