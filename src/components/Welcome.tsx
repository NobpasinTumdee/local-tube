    ...
    <div className="flex min-h-screen items-center justify-center bg-base px-4">
      ...
      <div className="relative flex w-full max-w-lg flex-col items-center gap-8 rounded-2xl border border-content/5 bg-content/[0.03] p-12 text-center backdrop-blur-md">
        ...
        <div className="relative flex items-center gap-2 text-2xl font-bold tracking-tight select-none">
          <svg viewBox="0 0 90 20" className="h-7 w-auto fill-content">
            <rect x="0" y="1" width="28" height="18" rx="4" className="fill-primary" />
            <polygon points="11,5 11,15 21,10" className="fill-content" />
            <text x="32" y="15.5" fontFamily="Roboto,sans-serif" fontWeight="700" fontSize="14" className="fill-content">
              LocalTube
            </text>
          </svg>
        </div>

        <p className="text-sm leading-relaxed text-content/50 max-w-xs">
        ...
        <button
          onClick={onPick}
          id="pick-folder-btn"
          className="group relative overflow-hidden rounded-full bg-primary px-8 py-3 text-sm font-semibold tracking-wide text-content shadow-lg shadow-primary/25 transition-all hover:shadow-primary/40 hover:scale-[1.03] active:scale-[0.97]"
        >
          <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-content/15 to-transparent transition-transform duration-500 group-hover:translate-x-full" />
