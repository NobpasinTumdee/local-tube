...
import { AlertTriangle, Ban, Check, ChevronDown, Copy, Dices, Eye, EyeOff, Info, KeyRound, Loader2, Power, RadioTower, Send, Share2, ShieldAlert, ShieldCheck, Unplug, UserCheck, Users, X, } from 'lucide-react';
    ...
    async function start() {
        ...
        try {
            ...
            await startSession({
                ...
                password,
                displayName: name,
                signaling: advanced && signaling.host.trim()
                    ? {
