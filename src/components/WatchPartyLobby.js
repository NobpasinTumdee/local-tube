 ...
 */
export default function WatchPartyLobby({ embedded = false }) {
    ...
    return createPortal(_jsx("div", { className: compact
            ...
            : 'fixed inset-0 z-[320] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm', children: card }), document.body);
}
